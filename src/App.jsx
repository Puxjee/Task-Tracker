...
const App = () => {
  ...
  return (
    <div className='min-h-screen bg-[#f0f2f5] flex items-center justify-center p-4 animate-fade-in'>
      <div className='grid grid-cols-1 md:grid-cols-2 w-[50vw] h-[40vw] bg-[#ffffff] shadow-xl rounded-xl p-8'>
